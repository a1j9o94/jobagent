...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_credential_site_hostname'), 'credential', ['site_hostname'], unique=False)
    ...
    sa.Column('status', sa.Enum('SOURCED', 'RANKED', 'APPLYING', 'APPLIED', 'IGNORED', name='rolestatus'), nullable=False),
    ...
    op.create_index(op.f('ix_userpreference_key'), 'userpreference', ['key'], unique=False)
    op.create_table('application',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('role_id', sa.Integer(), nullable=False),
    sa.Column('profile_id', sa.Integer(), nullable=False),
    sa.Column('celery_task_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('status', sa.Enum('DRAFT', 'NEEDS_USER_INFO', 'READY_TO_SUBMIT', 'SUBMITTING', 'SUBMITTED', 'ERROR', 'REJECTED', 'INTERVIEW', 'OFFER', 'CLOSED', name='applicationstatus'), nullable=False),
    sa.Column('resume_s3_url', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('cover_letter_s3_url', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(op.f('ix_application_celery_task_id'), 'application', ['celery_task_id'], unique=False)
    op.create_table('roleskilllink',
    sa.Column('role_id', sa.Integer(), nullable=False),
