...
class BrowserAutomation:
    ...
    async def submit_job_application(
        self, posting_url: str, form_data: Dict[str, Any], credentials: Dict[str, str]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"status": "error", "message": str(e), "screenshot_taken": True}
        finally:
            await page.close()

    async def _submit_greenhouse_form(
        self, page: Page, form_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if "resume_path" in form_data:
                await page.set_input_files(
                    'input[type="file"]', form_data["resume_path"]
                )
    ...
    async def _submit_workday_form(
        self, page: Page, form_data: Dict[str, Any], credentials: Dict[str, str]
    ) -> Dict[str, Any]:
    ...
    async def _submit_lever_form(
        ...
        try:
            ...
            if "resume_path" in form_data:
                await page.set_input_files(
                    'input[name="resume"]', form_data["resume_path"]
                )
    ...
    async def _submit_generic_form(
        self, page: Page, form_data: Dict[str, Any]
    ) -> Dict[str, Any]:
